...
@implementation YSCoreDataStack
...
//singleton, reusable fileㅡ두
+ (instancetype)defaultStack{

    static YSCoreDataStack *defaultStack;
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "NHNNEXT.Diary" in the application's documents directory.
